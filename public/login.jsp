...
-->
	...
	<link rel="stylesheet" type="text/css" href="<c:url value='/css/common,login,zhtml,skin.css'>
		...
		<c:param name="skin"    value="simpon-style" />
	...
	<link rel="stylesheet" type="text/css" href="skins/simpon-style/skin.css"/>
	<style>
		.simpon-style .title-site {
			display: block;
			font-family: arial;
			font-size: 16px;
			height: 20px;
		...
		.simpon-style .title-site span{}
		.simpon-style .ImgLoginBanner{}
		.simpon-style .LoginScreen, .SplashScreen, .ErrorScreen{ background:none;}
		.simpon-style .LoginScreen .Footer
		.LoginScreen .Footer, .SplashScreen .Footer, .LoginScreen .Footer-small, .SplashScreen .Footer-small{
			background-color: #dfdfdf;
			background-image: url("skins/simpon-style/img/bg-top-nav-1.jpg");
		...
		/*
		.simpon-style .LoginScreen .center{
			background-image: url("skins/simpon-style/img/logo-pon-peparnas.png");
		...
		.logo-simpon .img-logo {
			/*background-image: url("skins/simpon-style/img/logo-pon-peparnas.png");*/
			background-image: url("skins/simpon-style/img/webmail-pon-logo-pon.png");
		...
		.LoginScreen::before{ background-image:url("skins/simpon-style/img/webmail-pon-batik.jpg"); height:100%; bottom:5px;}
		.LoginScreen::after {
			background-image: url("skins/simpon-style/img/webmail-pon-bg-logo-trans.png");
			background-position: left center;
			background-repeat: no-repeat;
			content: "";
			display: block;
		...
		input#username.zLoginField:placeholder{ display:block;content:"Username";}
		input#password.zLoginField:placeholder{ display:block;content:"Password";}
		...
		.form TD:first-child LABEL{display:none;}
		.form HR{box-shadow:0 -1px rgba(0, 0, 0, 0.2); border-color:rgba(255, 255, 255, 0.56) transparent transparent transparent}
		.form .ZLoginButton {
			background-color: #0cb3ef;
			border-color: #0cb3ef;
			color: white;
		}
		.form .ZLoginButton:hover{ color:white;}
		.LoginScreen .center {top:35%;}
		.LoginScreen .contentBox{width:300px;}
		.contentBox h1{ margin-top:30px;}
		.contentBox h1 a:hover,
		.contentBox h1 a{ color:#fff; text-decoration:none;}
		.LoginScreen.login-box .center-small{ width:90%; margin-left:auto; margin-right:auto; right:auto; left:auto; position:relative;}
...
<body onload="onLoad();" class="simpon-style">
	<div class="title-site"><span style="color:#007cc3;">WebMail</span> <b>PON-PEPARNAS</b> JABAR 2016</div>
	<div class="logo-simpon">
		<div class="img-logo"></div>
	</div>
	<div class="LoginScreen login-box">
		<div class="${smallScreen?'center-small':'center'}">
			<div class="contentBox">
				...
				-->
				<h1><a href="http://www.zimbra.com" title="Zimbra"> WebMail</a></h1>
						...
						<c:otherwise>
										<c:choose>
											<c:when test="${not empty virtualacctdomain or not empty param.virtualacctdomain}">
												...
												<tr>
													...
													<td><input id="username" class="zLoginField" placeholder="Username" name="username" type="text" value="${fn:escapeXml(param.username)}" size="40" maxlength="${domainInfo.webClientMaxInputBufferLength}"/></td>
												</tr>
											</c:when>
											<c:otherwise>
												...
												<tr>
													...
													<td><input id="username" class="zLoginField" placeholder="Username" name="username" type="text" value="${fn:escapeXml(param.username)}" size="40" maxlength="${domainInfo.webClientMaxInputBufferLength}" autocapitalize="off" autocorrect="off"/></td>
												</tr>
											</c:otherwise>
										</c:choose>
										<tr>
											<td><label for="password"><fmt:message key="password"/>:</label></td>
											<td><input id="password" autocomplete="off" placeholder="Password" class="zLoginField" name="password" type="password" value="" size="40" maxlength="${domainInfo.webClientMaxInputBufferLength}"/></td>
										</tr>
							<c:if test="${errorCode eq 'account.CHANGE_PASSWORD' or !empty param.loginNewPassword }">
										<tr>
											...
											<td><input id="loginNewPassword" autocomplete="off" placeholder="Password" class="zLoginField" name="loginNewPassword" type="password" value="${fn:escapeXml(param.loginNewPassword)}" size="40" maxlength="${domainInfo.webClientMaxInputBufferLength}"/></td>
										</tr>
										<tr>
